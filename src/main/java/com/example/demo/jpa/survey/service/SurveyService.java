//package com.example.demo.jpa.survey.service;
//
//import com.example.demo.jpa.admin.model.Admin;
//import com.example.demo.jpa.admin.repository.AdminRepository;
////import com.example.demo.jpa.image.ImageService;
//import com.example.demo.jpa.survey.domain.dto.*;
...
//import com.example.demo.jpa.survey.repository.SurveyRewardRepository;
...
//        // s3에 저장
//        List<String> savedFileUrls = imageService.saveMultiPartFiles("설문조사보상",multipartFiles);
//
//        // 로컬 DB에 정보 저장
//        Optional<SurveyEntity> findSurveyEntity = surveyEntityRepository.findByInviteCode(inviteCode);
//
